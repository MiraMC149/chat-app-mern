...
export default function Login({ setIsAuthenticated, isAuthenticated }) {
  ...
  return (
    <form className='bg-indigo-600 w-full h-full'>
      <img
        src={LoginBg}
        alt=""
      ...
      <div className='z-20 absolute right-10 top-5 lg:right-[15%] lg:top-[10%] bg-white flex flex-col p-6 items-center rounded-3xl h-[95vh] w-[80vw] lg:h-[80vh] lg:w-[70vw] justify-center lg:flex-row '>
        ...
        <div className='flex flex-col py-6 h-full w-[50vw]'>
          ...
          <div className='flex flex-col text-sm mt-[2vh] lg:mt-8 w-[95%]'>
            ...
            <input type="text" name='username' onChange={(e)=>setUsername(e.target.value)} required className='ring-2 mt-3 py-1 px-3 ring-indigo-300 rounded-lg focus:outline-0 focus:ring-2 focus:ring-indigo-600' placeholder="Enter your username"/>
          </div>
          <div className='flex flex-col relative text-sm w-[95%] pt-4'>
            <label>Password</label>
            <input type={eye === EyeIcon ? "password" : "text"} name='password' required onChange={(e)=>setPass(e.target.value)} className='ring-2 mt-3 py-1 px-3 ring-indigo-300 rounded-lg focus:outline-0 focus:ring-2 focus:ring-indigo-600' placeholder="Enter your password"/>
            {
              eye === EyeIcon
...
>Sign in</button>       
          ...
          <div className='flex mt-7 text-center justify-between w-[95%]'>
            <div as="button" onClick={() => login()} className='flex items-center justify-center border-2 border-red-400 text-red-500 font-semibold rounded-lg p-2 w-[45%] hover:text-white hover:bg-red-400 hover:cursor-pointer'>
              <img src={GoogleSvg} />
